...
hour_entry = Entry(gui,bg="gray94", fg= "gray0", font=("PT Serif",18),width=5,textvariable=hour)
hour_entry.place(x=45 ,y=45)

minute_entry = Entry(gui,bg="gray94", fg= "gray0", font=("PT Serif",18),width=5,textvariable=minute)
minute_entry.place(x=145 ,y=45)

second_entry = Entry(gui,bg="gray94", fg= "gray0", font=("PT Serif",18),width=5,textvariable=second)
...
b1 = Button(gui,highlightbackground="gray94",fg="gray0",text = "Start Timer",font=("PT Serif",20),width=10,command=start_timer)
b1.place(x=85 ,y=125)
